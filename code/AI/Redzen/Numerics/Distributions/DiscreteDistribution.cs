    ...
    // where T : struct, IBinaryFloatingPointIeee754<T>
{
    ...
    /// </summary>
    public static readonly DiscreteDistribution<T> SingleOutcome = new(new double[] { 1 });
    ...
    public DiscreteDistribution<double> RemoveOutcome(int labelId)
    {
        ...
        return new DiscreteDistribution<double>(probArr, labels);
    }
    ...
    private static readonly double __nearZeroThreshold = 0.000_001;
    ...
    private static void NormaliseProbabilities(Span<double> pSpan)
    {
		...
		double sum = MathSpan.Sum<double>(pSpan);
