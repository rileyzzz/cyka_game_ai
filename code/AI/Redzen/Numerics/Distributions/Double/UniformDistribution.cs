...
public static class UniformDistribution
{
    ...
    {
        Sandbox.Diagnostics.Assert.True(max >= 0.0);
    ...
    {
        Sandbox.Diagnostics.Assert.True(max >= min);
    ...
    {
		x = BitConverter.UInt64BitsToDouble( BitConverter.DoubleToUInt64Bits( x ) | signBit );
