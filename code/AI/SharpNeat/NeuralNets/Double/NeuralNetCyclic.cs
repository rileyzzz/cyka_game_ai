...
//        int tgtIdsRef = 0;
//        int weightsRef = 0;
//        int preActivationsRef = 0;
//        int postActivationsRef = 0;
//        int preActivationsNonInputsRef = 0;
//		int postActivationsNonInputsRef = 0;
...
//            {
//				preActivations[preActivationsRef + tgtIds[tgtIdsRef + j]] =
//                    Math.FusedMultiplyAdd(
//						postActivations[postActivationsRef + Unsafe.Add(ref srcIdsRef, j)],
//						weights[weightsRef + j],
//						preActivations[preActivationsRef + Unsafe.Add(ref tgtIdsRef, j))];
//            }
